...
const About = () => {
  ...
  return (
    <section id="about" ref={ref}>
      <div className="w-full min-h-screen px-2 md:px-10 flex md:flex-row flex-col justify-between md:items-start pb-28 md:pb-0 mb-12 border-b-[1px] border-border relative">
